...
// global shader program that is used by all of gl_LFont instances
...
struct gl_lfont_polygon_program2d_;
extern struct gl_lfont_polygon_program2d_* shared_font_shaderprogram;
...
/// \param align Alignment to align text within the given area. See gl_LFont_TextAlignment.
///
